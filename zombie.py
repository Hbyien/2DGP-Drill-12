...
import play_mode
from state_machine import downkey_up
...
class Zombie:
    ...
    def __init__(self, x=None, y=None):
        ...
        self.patrol_locations = [(100 ,274), (1118, 274), (1050, 494), (575, 494), (235, 991), (575, 911), (1050, 494),(1118, 494)]
        self.loc_no = 0
    ...
    def run_away(self, r = 0.5):
        self.dir2 = math.atan2(self.y - play_mode.boy.y, self.x - play_mode.boy.x)
        distance3 = RUN_SPEED_PPS * game_framework.frame_time
        self.x += distance3 * math.cos(self.dir2)
        self.y += distance3 * math.sin(self.dir2)
    ...
    def build_behavior_tree(self):
        ...
        a4 = Action('소년한테 접근', self.move_to_boy)
        root = more_ball_than_boy = Sequence('소년보다 공이 많다.', c2, a4)
        a5 = Action('도망가기',self.run_away)
        root = chase_or_run = Selector('추적 또는 도망', more_ball_than_boy, a5)
        c1 = Condition('소년이 근처에 있는가?', self.is_boy_nearby, 7)
        root = chase_boy = Sequence('소년을 추적', c1, chase_or_run)
